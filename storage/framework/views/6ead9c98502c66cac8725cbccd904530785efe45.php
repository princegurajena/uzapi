...
<script>
    ...
    $(function () {
        ...
        $(document).ready(function () {
            ...
            var relationComponent = $(relationStr).filter("tr").load('<?php echo url(''); ?>/relation_field_template');
            ...
            $('#rollbackForm').on("submit", function (e) {
                ...
                $.ajax({
                    url: '<?php echo url(''); ?>/generator_builder/rollback',
                    method: "POST",
                    dataType: 'json',
                    contentType: 'application/json',
                    data: JSON.stringify(data),
            ...
            $('#schemaForm').on("submit", function (e) {
                ...
                $.ajax({
                    url: '<?php echo url(''); ?>/generator_builder/generate-from-file',
                    type: 'POST',
...
<?php /**PATH C:\Users\gujie-code-king\Desktop\Code\Packages\UZApi\UzMobileApi\resources\views/vendor/generator_builder/builder.blade.php ENDPATH**/ ?>